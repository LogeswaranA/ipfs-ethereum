const _2_deploy_contracts = require("./2_deploy_contracts")
// @ponicode
describe("_2_deploy_contracts", () => {
    test("0", () => {
        let callFunction = () => {
            _2_deploy_contracts({ deploy: () => "commit e6d1117d97e7cc250166120d2eee1c2662c58150\r\nAuthor: Keagan Cole <Crystal69@gmail.com>\r\nDate: Thu Jul 29 2021 05:36:16 GMT+0200 (Central European Summer Time)\r\n\r\n    override wireless alarm\r\n" })
        }
